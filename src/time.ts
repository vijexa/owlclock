import { DateTimeFormatter, LocalDate, LocalDateTime, LocalTime, Period } from "@js-joda/core";
...
export function calculateDaysPassed(time: LocalTime, unit: Units, inputValue: number): number {
  ...
  const period = Period.between(oldLocalDateTime.toLocalDate(), newLocalDateTime.toLocalDate());
